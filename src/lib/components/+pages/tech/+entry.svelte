...
<div class="absolute inset-0 flex justify-center overflow-y-auto">
	<AnimateSectionIn containerWidth={1000} color="red" skipWidthAnimation>
		<div>
			<div class="">
				<h2
					class="mb-xxs font-medium uppercase tracking-wider text-red-10 text-sm xs:text-base sm:text-lg md:text-2xl cursor-pointer sm/md:cursor-auto"
				>
					Tech Stuff
				</h2>
				...
				<div class="mt-md overflow-auto pb-md pr-md">
					<div
						class="inline-grid border grid-cols-6 border-gray-4 text-base text-gray-11 w-[900.3px]"
					>
						<div
						...
						<div
							class="box uppercase text-xs tracking-wide underline decoration-dashed border-y text-gray-12"
						>
							styling
						</div>
						...
						<div
							class="box uppercase text-xs tracking-wide underline decoration-dashed text-gray-12"
						>
							scripting
						</div>
						...
						<div
							class="box border-t uppercase text-xs tracking-wide underline decoration-dashed text-gray-12"
						>
							platforms
						</div>
						<div class="box text-sm lg:text-base border-t border-l border-gray-11">squarespace</div>
						<div class="box text-sm lg:text-base border-t border-l">wix</div>
						<div class="box text-sm lg:text-base border-t border-l">shopify</div>
						<div class="box text-sm lg:text-base border-t border-l">stripe</div>
