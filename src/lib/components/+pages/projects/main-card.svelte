...
<div class="pr-md">
	...
	<div class="mt-xs flex gap-xs items-center">
		<h4 class="text-blue-10 uppercase text-xs tracking-wider">{data.title}</h4>
		...
		<div class="flex gap-xs items-end">
			<div class="flex items-center gap-xxs">
				...
				<button on:click={data.onClickInfo} type="button" />
			</div>
			...
			<div class="flex items-center gap-xxs">
				...
				<a
					...
					target="_blank"
				>
					<span class="text-xs tracking-wider">Visit</span>
