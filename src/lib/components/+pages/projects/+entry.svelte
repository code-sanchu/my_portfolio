...
<div
	class="flex flex-col gap-md md:flex-row md:gap-0 max-h-full pb-md overflow-y-auto scrollbar-none"
>
	<AnimateSectionIn containerWidth={320} color="blue" skipWidthAnimation>
		<div>
			<h2 class="title text-blue-10 sm:text-lg md:text-2xl">Projects</h2>
			...
			<div class="mt-xxs flex flex-col gap-xxxs sm:gap-xxs">
				{#each Object.values(projects) as project}
					...
					<h4
						class="title project-title sm:text-lg md:text-2xl"
						on:click={() =>
							(shownProjects = [
