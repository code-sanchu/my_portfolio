...
<div class="pb-xl md:pb-2xl xl:pb-3xl 3xl:pb-[12rem]">
	...
	>
		<div class="relative w-full min-w-[240px] xs:min-w-[300px] xs/sm:min-w-[320px]">
			<div
				class="absolute inset-0 opacity-0 transition-opacity duration-[400ms] ease-in-out"
	...
	<div
		class="mt-lg md:mt-[4.5rem] xl:mt-[7rem] flex justify-center opacity-0 transition-opacity duration-[400ms] ease-in-out"
		style:opacity={!sectionReady?.main ? 0 : 1}
		id="home-section"
	>
		<Heading />
	...
	<div
		class="mt-2xl md:mt-[7.5rem] xl:mt-[12rem] 2xl:mt-[15rem] opacity-0 transition-opacity duration-[400ms] ease-in-out"
		style:opacity={!sectionReady?.main ? 0 : 1}
	>
	...
	<div
		class="mt-lg md:mt-xl lg:mt-[3.75rem] transition-opacity duration-[400ms] ease-in-out"
		style:opacity={!sectionReady?.main ? 0 : 1}
		id="projects-section"
	>
		<Section.LeftSpacing>
